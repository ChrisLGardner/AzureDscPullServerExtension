...
Foreach ($Config in $Configs) {
    ...
    Foreach ($Import in $ImportDscResources) {
        ...
        $ModuleName | Get-Memeber | Where-Object MemberType -in @('Property','ScriptProperty','NoteProperty') |Select-Object -ExpandProperty Name | Foreach-Object { Write-Verbose -Message "Found $($moduleName.$_)"}
